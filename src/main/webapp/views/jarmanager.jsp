...
<div class="main-content" style="background-color: #eff0f4!important;">
    ...
    <div class="wrapper" style="padding: 15px;height: 100%">
        <p>
            ...
            参数:java.io.InputStream<br/>
            返回值:java.lang.String(JSON字符串)<br/>
            如需进行空间查询,必须包含如下字段<br/>
                (上:)top<br/>
                (下:)bottom<br/>
                (左:)left<br/>
                (右:)right<br/>
        ...
        <div class="container-fluid">
            <table id="configTable" class="table table-responsive table-condensed table-bordered table-striped">
        ...
        <div id="editPanel">
            <form id="jarForm" class="form-horizontal" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-10">
                        <textarea type="text" class="form-control" id="desInput" placeholder="解析描述说明" name="des"
                                  rows="3"></textarea>
                    </div>
                </div>
                <div class="form-group">
        ...
        <div>
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td width="658" align="left" valign="center">
                        ...
                        <div class="para" label-module="para">此处用或任意一项都不能超过2位，如“(?&lt;!95|98|NT|20)Windows正确，“(?&lt;!95|980|NT|20)Windows
                            报错，若是单独使用则无限制，如(?&lt;!2000)Windows 正确匹配
                        </div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td align="left" valign="center">
                        <div class="para" label-module="para">小写 p 是 property 的意思，表示 Unicode 属性，用于 Unicode
                ...
                <tr>
                    ...
                    <td align="left" valign="center">匹配词（word）的开始（&lt;）和结束（&gt;）。例如正则表达式&lt;the&gt;能够匹配字符串"for the
                ...
                <tr>
                    <td align="left" valign="center">|</td>
                    <td align="left" valign="center">将两个匹配条件进行逻辑“或”（Or）运算。例如正则表达式(him|her) 匹配"it belongs to him"和"it
                        belongs to her"，但是不能匹配"it belongs to them."。注意：这个元字符不是所有的软件都支持的。
                    </td>
                </tr>
                <tr>
                    <td align="left" valign="center">+</td>
