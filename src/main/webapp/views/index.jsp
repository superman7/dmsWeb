...
<div class="main-content">
    ...
    <div class="header-section">
        ...
        <div class="tools">
            ...
            <button class="btn btn-warning">
                ...
                <span class="label" data-bind="click:createDirectory">新建文件夹</span>
            </button>
        </div>
        <div class="right-tools">
            <div class="searchForm input-group ">
                ...
                <span class="input-group-btn">
                    <button type="button" class="btn btn-default" data-bind="click:searchFiles,event:{mouseout:mouseoutSearchBtn}">
    ...
    <div class="page-heading">
        <div class="module-history-list">
            ...
            <ul class="historylistmanager-history" data-bind="visible:currentPathArray().length>0">
                <li>
                    <a href="javascript:void(0);" data-bind="click:returnBackPath">返回上一级</a>
                    <span class="historylistmanager-separator">|</span>
                    <a href="javascript:void(0);" data-bind="click:openRootPath">全部文件</a>
            ...
            <span class="history-list-tips">已全部加载，共<label data-bind="text:filesToShow().length"></label>个</span>
        </div>
        <div class="list-header">
            <ul class="list-cols">
                <li class="col" data-bind="css:{checked:isCheckedAll},style:{width:showList()?'60%':'100%'}">
            ...
            <div class="list-header-operatearea" data-bind="visible:checkedCount()>0">
                <span class="count-tips">已选中<label data-bind="text:checkedCount()"></label>个文件/文件夹</span>
                <div class="list-header-operate">
                    <button type="button" class="btn btn-default">
                        <i class="fa fa-arrow-circle-down"></i>
                        <span class="label">下载</span>
                    </button>
                    <button type="button" class="btn btn-default" data-bind="click:delFiles">
                        <i class="fa fa-trash-o"></i>
                        <span class="label">删除</span>
                    </button>
                    <!-- ko if:checkedCount()==1 -->
                    <button type="button" class="btn btn-default" data-bind="click:rename">
                        <i class="fa fa-edit"></i>
                        <span class="label">重命名</span>
                    </button>
                    <!-- /ko -->
                    <button type="button" class="btn btn-default" data-bind="click:move">
    ...
    <div class="wrapper module-list">
        ...
        <div class="list-view" data-bind="foreach:filesToShow">
            <div class="list-view-item" data-bind="css:{'item-active':checked}">
                ...
                <div class="ctime" data-bind="text:mtime,style:{width:$parent.showPath()?'13%':'23%'}"></div>
                <!-- ko if : $parent.showPath() -->
                <div class="path-info" style="width:10%">
                    <span class="search-feild" data-bind="text:$parent.formatterPath($data),attr:{title:$parent.formatterPath($data)},click:$parent.openSeachPath"></span>
                </div>
                <!-- /ko -->
            </div>
        </div>
        ...
        <div class="grid-view" data-bind="foreach:filesToShow">
            <div class="grid-view-item"
                ...
                <div class="fileicon " data-bind="css:cssName+'-l',click:$parent.itemClick">
                    <!--ko if: src -->
                    <img class="thumb" data-bind="attr:{src:src,max:maxSrc,alt:name},event:{load:$parent.onImageLoad }">
                    <!--/ko -->
                    <span class="checkbox" data-bind="click:$parent.checkitem,clickBubble:false"></span>
                </div>
        ...
        <div class="module-edit-name" data-bind="css:{'module-edit-name-grid':!showList()}">
            <div class="new-dir-item">
                <input class="box" type="text" data-bind="value:newFileName"/>
                <span class="sure" data-bind="click:submitCreateDirectoryOrRename">
                    <i class="fa fa-check"></i>
                </span>
                <span class="cancel" data-bind="click:cancelCreteDirectoryOrRename">
